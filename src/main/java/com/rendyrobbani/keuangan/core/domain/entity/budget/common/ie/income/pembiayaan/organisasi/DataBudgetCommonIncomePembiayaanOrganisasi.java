package com.rendyrobbani.keuangan.core.domain.entity.budget.common.ie.income.pembiayaan.organisasi;
...
public interface DataBudgetCommonIncomePembiayaanOrganisasi extends DataBudgetCommonOrganisasiEntity,
                                                                    HasLock,
                                                                    HasLockMutator {

	String TABLE_NAME = "data_budget_common_income_pembiayaan_organisasi";
