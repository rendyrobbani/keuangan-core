...
public interface SipdMasterRekeningBelanja5 extends SipdMasterRekening5<DataMasterRekeningBelanja5> {

	String TABLE_NAME = "sipd_master_rekening_belanja5";
	...
	@Override
	DataMasterRekeningBelanja5 subject();
