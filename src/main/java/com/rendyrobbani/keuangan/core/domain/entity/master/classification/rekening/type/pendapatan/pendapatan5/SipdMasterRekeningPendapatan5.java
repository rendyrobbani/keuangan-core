...
public interface SipdMasterRekeningPendapatan5 extends SipdMasterRekening5<DataMasterRekeningPendapatan5> {

	String TABLE_NAME = "sipd_master_rekening_pendapatan5";
	...
	@Override
	DataMasterRekeningPendapatan5 subject();
