...
public interface SipdMasterRekeningPendapatan1 extends SipdMasterRekening1<DataMasterRekeningPendapatan1> {

	String TABLE_NAME = "sipd_master_rekening_pendapatan1";
	...
	@Override
	DataMasterRekeningPendapatan1 subject();
