...
public interface SipdMasterRekeningBeban4 extends SipdMasterRekening4<DataMasterRekeningBeban4> {

	String TABLE_NAME = "sipd_master_rekening_beban4";
	...
	@Override
	DataMasterRekeningBeban4 subject();
