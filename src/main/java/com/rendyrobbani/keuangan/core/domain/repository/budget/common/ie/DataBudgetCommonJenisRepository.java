...
public interface DataBudgetCommonJenisRepository<ENTITY extends DataBudgetCommonJenisEntity> extends DataBudgetCommonRepository<ENTITY, String> {
	...
	void deleteByUnitIdAndBidangIdAndJenisId(Connection connection, LocalDateTime deletedAt, String deletedBy, String unitId, String bidangId, String jenisId);

	void updateByUnitIdAndBidangIdAndJenisId(Connection connection, LocalDateTime updatedAt, String updatedBy, String unitId, String bidangId, String jenisId);
