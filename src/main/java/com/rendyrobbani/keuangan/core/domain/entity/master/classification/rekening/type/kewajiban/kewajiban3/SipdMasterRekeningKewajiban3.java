...
public interface SipdMasterRekeningKewajiban3 extends SipdMasterRekening3<DataMasterRekeningKewajiban3> {

	String TABLE_NAME = "sipd_master_rekening_kewajiban3";
	...
	@Override
	DataMasterRekeningKewajiban3 subject();
