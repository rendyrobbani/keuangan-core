...
public interface SipdMasterRekeningPendapatan3 extends SipdMasterRekening3<DataMasterRekeningPendapatan3> {

	String TABLE_NAME = "sipd_master_rekening_pendapatan3";
	...
	@Override
	DataMasterRekeningPendapatan3 subject();
