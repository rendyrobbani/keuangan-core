...
public interface DataMasterRekeningPendapatan6 extends DataMasterRekening6 {

	String TABLE_NAME = "data_master_rekening_pendapatan6";
	...
	void create(RekeningClassification classification, String name, boolean isEnabled, LocalDateTime createdAt, String createdBy);
